...
export function Hero() {
  return (
    <section className="relative overflow-hidden py-20 lg:py-32 flex flex-col justify-center bg-background">
      ...
      >
        ...
        <motion.p
          variants={fadeUpVariants}
          className="text-body-lg text-foreground-muted max-w-2xl mx-auto mb-10"
        >
          Halo, saya <span className="text-foreground font-semibold">{SITE_CONFIG.name}</span>. {SITE_CONFIG.shortBio}
        </motion.p>

        {/* Call to Actions */}
        <motion.div variants={fadeUpVariants} className="flex flex-wrap justify-center gap-4 mb-16">
